class CategoryAdapter {
    ...
    // constructor is my initalizer/blueprint (baby born with eyes, toes, no hair or lots of hair etc) and is where I will put the properies of the category adapter; I am setting the properties of the category adapter. 
    constructor(port){
